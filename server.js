...
const learningCatalog = learningLanguages.map(language => ({
  ...
  levels:Array.from({length:20},(_,levelIndex)=>({
    ...
    lessons:Array.from({length:20},(_,lessonIndex)=>{
      ...
      return {key,number:n,title:theme,objective:`Nivel ${levelIndex+1}: usar ${theme.toLowerCase()} en una situación real.`,task:`Crea una respuesta personal usando el vocabulario de la lección ${n}.`,practice:`Pronuncia: “${language.greeting}, I am ready to learn.” y escucha tu grabación.`,assessments:{checkpoint:{title:'Control de mitad',questions:[{id:'q1',prompt:`¿Cuál es el saludo inicial de ${language.language}?`,options:[language.greeting,'Gracias','Adiós'],answer:0},{id:'q2',prompt:'Selecciona la acción correcta para avanzar.',options:['Practicar y responder','Saltar sin estudiar','Cerrar la lección'],answer:0}]},final:{title:'Evaluación final',questions:[{id:'q1',prompt:`Completa el objetivo de la lección: ${theme}.`,options:['Aplicarlo en una frase','Ignorarlo','Memorizar sin practicar'],answer:0},{id:'q2',prompt:'¿Qué se exige para desbloquear la siguiente lección?',options:['80% o más','50%','Ninguna evaluación'],answer:0}]}}};
    })
  }))
}));
