...
,{ id:'159', name:'Interfaz Oficial y PIN de Prueba', status:'en_validacion', scope:'Registro y conversación comparten la interfaz oscura verde del boceto; el compositor permanece sobre el teclado universal, conserva llamadas y videollamadas y el acceso usa únicamente PIN local de prueba sin activar SMS de autenticación.' }
